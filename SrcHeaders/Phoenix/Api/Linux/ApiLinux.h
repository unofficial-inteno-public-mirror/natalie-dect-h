...
*
* MODULE: ApiLinux
* CONTROLLING DOCUMENT: Phoenix_API_Linux.doc   Revision: 41
* DESCRIPTION: Definition of the ApiLinux interface.
* This file is generated by Word from the interface document: Phoenix_API_Linux.doc using InterfaceMacro version 68
*
...
$Author:   tma  $
$Date:   24 Mar 2014 14:14:44  $
$Revision:   1.3  $
$Modtime:   24 Mar 2014 13:41:30  $
...
{
  RosPrimitiveType Primitive;            /*!< API_LINUX_INIT_REQ = 0x4712 */

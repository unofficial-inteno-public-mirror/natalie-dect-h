...
*
*  MODULE:                 ApiLasDb
*  CONTROLLING DOCUMENT:   Phoenix_API_LAS_DB.doc   Revision: 10
*  SYSTEM DEPENDENCIES:
*
*  DESCRIPTION: Definition of the ApiLasDb interface.
*
*               This file is generated by Word from the interface document:
*                  Phoenix_API_LAS_DB.doc using InterfaceMacro version 60
*
...
$Author:   tma  $
$Date:   08 May 2012 08:09:30  $
$Revision:   1.7  $
$Modtime:   08 May 2012 07:40:00  $

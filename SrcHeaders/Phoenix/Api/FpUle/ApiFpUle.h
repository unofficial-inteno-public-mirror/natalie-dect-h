...
*
* MODULE: ApiFpUle
* CONTROLLING DOCUMENT: Phoenix_API_FP_ULE.docm   Revision: 213
* DESCRIPTION: Definition of the ApiFpUle interface.
* This file is generated by Word from the interface document: Phoenix_API_FP_ULE.docm using InterfaceMacro version 68
*
...
$Author:   td  $
$Date:   02 Dec 2014 14:35:56  $
$Revision:   1.20.2.1  $
$Modtime:   02 Dec 2014 09:25:14  $
...
/* Mail primitives:
  ...
  API_FP_ULE_SET_PVC_LEGACY_MODE_REQ=0x419E,
  ...
  API_FP_ULE_DATA_POLL_CFM = 0x41AD,
...
/*! ULE paging channel parameters, Id and periodicity.                     
                                                   Id shall be in range : 
   0?351   
    Pexp shall be 2  corresponding t 4 channels a 88 bit */
typedef struct ApiFpUlePage_t
{
  ApiFpUlePageCh_t Descriptor;          /*!< Selects broadcast or paging */
  rsuint16 Id;                          /*!< Paging id */
  rsuint8 Pexp;                         /*!< Periodicity in frames  = 2^Pexp */
} ApiFpUlePage_t;
...
/*! ULE PVC modes  
      Normal Mode:  Everything as specified by ETSI
      Legacy Mode:  Handle devices that don?t uses service call, but are ?
   Resumed? LR */
typedef enum RSENUMTAG(ApiFpUlePvcMode_t)
{
  API_ULE_PVC_MODE_NORMAL =0, /*!< Normal  ?ETSI? mode */
  API_ULE_PVC_MODE_LEGACY =1, /*!< Legacy mode */
} RSENUM8(ApiFpUlePvcMode_t);
...
/*! Received if PVC needs a configuration/reconfiguration or a reset. */
...
/*! Setup the FP PVC to handle legacy devices that are not using Service
   call */
typedef struct ApiFpUleSetPvcLegacyModeReqType
{
  RosPrimitiveType Primitive;            /*!< API_FP_ULE_SET_PVC_LEGACY_MODE_REQ=0x419E */
  ApiTerminalIdType TerminalId;         /*!< Terminal Id. */
  ApiFpUlePvcMode_t Mode;               /*!< Normal or Legacy mode */
} ApiFpUleSetPvcLegacyModeReqType;
...
/*! Request PP  to POLL FP with specified interval */
typedef struct ApiFpUleDataPollReqType
{
  RosPrimitiveType Primitive;            /*!< API_FP_ULE_DATA_POLL_REQ = 0x41AC */
  ApiTerminalIdType TerminalId;         /*!< Portable part number */
  rsuint16 PollInterval;                /*!< Poll interval in 10 ms ticks 0...1216 */
} ApiFpUleDataPollReqType;

/*! Confirmation that API_FP_ULE_DATA_POLL_REQ has been handled. */
typedef struct ApiFpUleDataPollCfmType
{
  RosPrimitiveType Primitive;            /*!< API_FP_ULE_DATA_POLL_CFM = 0x41AD */
  ApiTerminalIdType TerminalId;         /*!< Portable part number */
  RsStatusType Status;                  /*!< Status for the data poll  request */
} ApiFpUleDataPollCfmType;
...
/****************************************************************************
* FUNCTION:      SendApiFpUleSetPvcLegacyModeReq
* DESCRIPTION:   MPS function for sending mails with primitive:
*                API_FP_ULE_SET_PVC_LEGACY_MODE_REQ=0x419E
****************************************************************************/
void SendApiFpUleSetPvcLegacyModeReq ( RosTaskIdType Src,
                                       ApiTerminalIdType TerminalId,
                                                             /*!< Terminal Id. */
                                       ApiFpUlePvcMode_t Mode);
                                                             /*!< Normal or Legacy mode */
